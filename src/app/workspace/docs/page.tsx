...
export default function DocsHubPage() {
  ...
  // Fetch only 'doc' types SCOPED by companyId
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="space-y-1">
            <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900">Recent Documents</h1>
                    <p className="text-sm font-medium text-slate-500">Fast access to your team's rich text assets.</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid gap-3">
            {isLoading ? (
                ...
                <div className="py-24 text-center opacity-30 flex flex-col items-center gap-4 border-2 border-dashed rounded-3xl">
                    ...
                    <p className="text-sm font-bold uppercase tracking-widest text-slate-400">No documents found</p>
                </div>
            )}
        </div>
      </div>
