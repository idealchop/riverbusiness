      ...
      <div className="relative z-10 w-full max-w-2xl text-center space-y-8 animate-in fade-in zoom-in-95 duration-700">
        <div className="flex justify-center">
          <div className="p-6 rounded-3xl bg-blue-600/5 border border-blue-600/10 shadow-2xl relative group">
            <Users className="h-16 w-16 text-blue-600 transition-transform duration-500 group-hover:scale-110" />
          </div>
        </div>

        <div className="space-y-4">
          <h1 className="text-4xl font-black tracking-tighter text-slate-900 uppercase">
            HR & <span className="text-blue-600">Employee</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium max-w-md mx-auto">
            Automated payroll and team wellness modules are under intense development.
          </p>
        </div>
        ...
        <Card className="border-none shadow-2xl rounded-3xl bg-white/80 backdrop-blur-xl">
          <CardContent className="p-8 space-y-6">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Status: Engineering Pipeline</p>
            </div>
            <div className="w-full h-[2px] bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full bg-blue-600 w-[25%] animate-pulse" />
            </div>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Phase 1 Release: early 2026</p>
          </CardContent>
        </Card>
