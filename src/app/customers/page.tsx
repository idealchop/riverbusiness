  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden flex flex-col items-center justify-center p-4">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70%] h-[70%] rounded-full bg-blue-400/5 blur-[120px] animate-pulse" />
      ...
      <div className="relative z-10 w-full max-w-2xl text-center space-y-8 animate-in fade-in zoom-in-95 duration-700">
        <div className="flex justify-center">
          <div className="p-6 rounded-3xl bg-blue-400/5 border border-blue-400/10 shadow-2xl relative group">
            <Target className="h-16 w-16 text-blue-400 transition-transform duration-500 group-hover:scale-110" />
          </div>
        </div>

        <div className="space-y-4">
          <h1 className="text-4xl font-black tracking-tighter text-slate-900 uppercase">
            Client <span className="text-blue-400">Success CRM</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium max-w-md mx-auto">
            Centralized multi-site relationship management is being optimized.
          </p>
        </div>
        ...
        <Card className="border-none shadow-2xl rounded-3xl bg-white/80 backdrop-blur-xl">
          <CardContent className="p-8 space-y-6">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Status: Interface Modeling</p>
            </div>
            <div className="w-full h-[2px] bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full bg-blue-400 w-[15%] animate-pulse" />
            </div>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Public Beta: Q3 2025</p>
          </CardContent>
        </Card>
