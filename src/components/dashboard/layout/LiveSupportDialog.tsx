...
import { Mail, Phone, MessageSquare, FileUp, Headset } from 'lucide-react';
import type { AppUser } from '@/lib/types';
import { FeedbackDialog } from '../dialogs/FeedbackDialog';
import { SwitchProviderDialog } from '../dialogs/SwitchProviderDialog';
...
export function LiveSupportDialog({ isOpen, onOpenChange, user, chatMessages, onMessageSubmit, children }: LiveSupportDialogProps) {
